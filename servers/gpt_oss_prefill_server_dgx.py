#!/usr/bin/env python3
"""
GPT-OSS Prefill Server for DGX Spark 2
...
# Ollama configuration for DGX Spark 2
...
def health_check():
    ...
    return jsonify({
        'status': 'healthy',
        'model': MODEL_NAME,
        'server': 'DGX Spark 2 - GPT-OSS Prefill',
        'role': 'prefill'
    })
...
def get_status():
    ...
    return jsonify({
        'server': 'GPT-OSS Prefill Server',
        'model': MODEL_NAME,
        'dgx': 'Spark 2',
        'role': 'prefill',
        'purpose': 'Feedback Generation Prefill'
    })

if __name__ == '__main__':
    print("🖥️ Starting GPT-OSS Prefill Server on DGX Spark 2...")
