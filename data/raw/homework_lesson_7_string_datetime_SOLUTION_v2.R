...
# SOLUTION for Version 2 (Processed Data)
# This solution works with data from data/processed/
...
# NOTE: Using processed data with different column names
...
# Data has: "4/5/24 14:30" (mdy HM) and "25-03-2024 16:45:30" (dmy HMS)
...
# SOLUTION: Create synthetic customer names or use CustomerID

# Create customer names from CustomerID
customer_outreach <- transactions_clean %>%
  mutate(
    # Create customer name from ID (in real scenario, would join with customer table)
